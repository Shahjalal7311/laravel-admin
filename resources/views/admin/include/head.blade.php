...
<meta name="description" content="Laravel Templete">
...
<link href="{{ asset('plugins/ionicon/css/ionicons.min.css') }}" rel="stylesheet" />
...
<!-- sweet alerts -->
<link href="{{ asset('plugins/sweet-alert/sweet-alert.min.css') }}" rel="stylesheet">
