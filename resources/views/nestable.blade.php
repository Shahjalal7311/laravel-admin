...
<div class="wraper container-fluid">
				<div class="page-title">
					...
					<a href="http://dbushell.github.io/Nestable/" class="btn btn-primary pull-right">Full Documentation</a>
				</div>

				<div class="row">
					<div class="col-lg-12">
						<div class="text-center" id="nestable_list_menu">
							<button type="button" class="btn btn-pink" data-action="expand-all">
								Expand All
							</button>
							<button type="button" class="btn btn-purple" data-action="collapse-all">
								Collapse All
							</button>
						</div>
					</div>
