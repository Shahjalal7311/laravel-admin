                ...
                <div class="portlet-body">
                    <ul class="list-group list-group-lg">
                        <li class="list-group-item b-0">
                            <a href="#" class=" m-r-10"> <img src="{{ asset('img/avatar-3.jpg') }}" class="thumb-sm br-radius"> </a>
                            <span class="pull-right label bg-primary inline m-t-10">Web Developer</span>
                            <a href="#">Camron Camden</a>
                        </li>
                        <li class="list-group-item b-0">
                            <a href="#" class=" m-r-10"> <img src="{{ asset('img/avatar-4.jpg') }}" class="thumb-sm br-radius"> </a>
                            <span class="pull-right label bg-info inline m-t-10">Mobile Developer</span>
                            <a href="#">Timothy Ridley</a>
                        </li>
                        <li class="list-group-item b-0">
                            <a href="#" class=" m-r-10"> <img src="{{ asset('img/avatar-5.jpg') }}" class="thumb-sm br-radius"> </a>
                            <span class="pull-right label bg-warning inline m-t-10">Web Developer</span>
                            <a href="#">Grady Graham</a>
                        </li>
                        <li class="list-group-item b-0">
                            <a href="#" class=" m-r-10"> <img src="{{ asset('img/avatar-6.jpg') }}" class="thumb-sm br-radius"> </a>
                            <span class="pull-right label bg-pink inline m-t-10">Mobile Developer</span>
                            <a href="#">Destinee Snowdon</a>
                        </li>
                        <li class="list-group-item b-0">
                            <a href="#" class=" m-r-10"> <img src="{{ asset('img/avatar-7.jpg') }}" class="thumb-sm br-radius"> </a>
                            <span class="pull-right label bg-warning inline m-t-10">Web Developer</span>
                        ...
                        <ul tabindex="5000" style="overflow: hidden;" class="conversation-list nicescroll">
                            <li class="clearfix">
                                <div class="chat-avatar">
                                    <img src="{{ asset('img/avatar-2.jpg') }}" alt="male">
                                    <i>10:00</i>
                                </div>
                            ...
                            <li class="clearfix odd">
                                <div class="chat-avatar">
                                    <img src="{{ asset('img/avatar-3.jpg') }}" alt="Female">
                                    <i>10:01</i>
                                </div>
                                <div class="conversation-text">
                                    <div class="chat-message">
                            ...
                            <li class="clearfix odd">
                                <div class="chat-avatar">
                                    <img src="{{ asset('img/avatar-3.jpg') }}" alt="male">
                                    <i>10:02</i>
                                </div>
                                <div class="conversation-text">
                                    <div class="chat-message">
